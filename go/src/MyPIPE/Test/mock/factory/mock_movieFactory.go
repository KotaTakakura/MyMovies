...
func (m *MockIMovieModelFactory) CreateMovieModel(uploaderID model.UserID, fileHeader, thumbnailHeader multipart.FileHeader) (*model.Movie, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateMovieModel", uploaderID, fileHeader, thumbnailHeader)
...
func (mr *MockIMovieModelFactoryMockRecorder) CreateMovieModel(uploaderID, fileHeader, thumbnailHeader interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateMovieModel", reflect.TypeOf((*MockIMovieModelFactory)(nil).CreateMovieModel), uploaderID, fileHeader, thumbnailHeader)
}
